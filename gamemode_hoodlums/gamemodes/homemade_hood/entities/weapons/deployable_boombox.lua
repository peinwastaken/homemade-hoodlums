...
SWEP.Author 				= "pein"
SWEP.Instructions			= "Plays various songs of the homemade variety."
...
SWEP.ViewModel				= "models/pein/boombox/boombox.mdl"
SWEP.WorldModel				= "models/pein/boombox/boombox.mdl"
...
function SWEP:PrimaryAttack()
	...
	if IsFirstTimePredicted() then
		...
		if tr.Hit and dot > 0.75 then
			if SERVER then
				local ent = ents.Create("ent_boombox")
				...
				ent:EmitSound(self.PlaceSound, 500)
