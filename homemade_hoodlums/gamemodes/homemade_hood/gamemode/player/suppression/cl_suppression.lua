...
net.Receive("SuppressPlayer", function()
    ...
    suppressionSharpen = math.Clamp(suppressionSharpen + amount * 0.15, 0, 1)
    suppressionVignette = math.Clamp(suppressionVignette + amount * 0.25, 0, 1)
